...
//        new Result(duration:227, task:Task.findByDescription("AA"), session:session_2).save()
        ...
        new Result(duration:0, task:Task.findByDescription("A"), session:session_2).save()
        new Result(duration:0, task:Task.findByDescription("B"), session:session_2).save()
        new Result(duration:0, task:Task.findByDescription("C"), session:session_2).save()
        new Result(duration:0, task:Task.findByDescription("D"), session:session_2).save()
        new Result(duration:0, task:Task.findByDescription("E"), session:session_2).save()
        new Result(duration:0, task:Task.findByDescription("F"), session:session_2).save()
        new Result(duration:0, task:Task.findByDescription("G"), session:session_2).save()
        new Result(duration:0, task:Task.findByDescription("H"), session:session_2).save()
        new Result(duration:0, task:Task.findByDescription("I"), session:session_2).save()
        new Result(duration:0, task:Task.findByDescription("J"), session:session_2).save()
        new Result(duration:0, task:Task.findByDescription("K"), session:session_2).save()
        new Result(duration:0, task:Task.findByDescription("L"), session:session_2).save()
        new Result(duration:0, task:Task.findByDescription("M"), session:session_2).save()
        new Result(duration:0, task:Task.findByDescription("N"), session:session_2).save()
        new Result(duration:0, task:Task.findByDescription("O"), session:session_2).save()
        new Result(duration:0, task:Task.findByDescription("P"), session:session_2).save()
        new Result(duration:0, task:Task.findByDescription("Q"), session:session_2).save()
        new Result(duration:0, task:Task.findByDescription("R"), session:session_2).save()
        new Result(duration:0, task:Task.findByDescription("S"), session:session_2).save()
        new Result(duration:0, task:Task.findByDescription("T"), session:session_2).save()
        new Result(duration:0, task:Task.findByDescription("U"), session:session_2).save()
        new Result(duration:0, task:Task.findByDescription("V"), session:session_2).save()
        new Result(duration:0, task:Task.findByDescription("W"), session:session_2).save()
        new Result(duration:0, task:Task.findByDescription("X"), session:session_2).save()
        new Result(duration:0, task:Task.findByDescription("Y"), session:session_2).save()
        new Result(duration:0, task:Task.findByDescription("Z"), session:session_2).save()
        new Result(duration:0, task:Task.findByDescription("AA"), session:session_2).save()
    }
    def destroy = {
    }

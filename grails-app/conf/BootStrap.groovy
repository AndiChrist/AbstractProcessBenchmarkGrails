...
//        new Task(session:session_1, sequence:27, layer1:l_2, layer2:l_24, layer3:l_245, role:user, user:michael, system:s_email, media:m_mail, view:explicit, description:"AA").save()
        ...
        // results
        new Result(startTime:50, endTime:101, task:Task.findByDescription("A"), session:session_1).save()
        new Result(startTime:50, endTime:102, task:Task.findByDescription("B"), session:session_1).save()
        new Result(startTime:50, endTime:103, task:Task.findByDescription("C"), session:session_1).save()
        new Result(startTime:50, endTime:104, task:Task.findByDescription("D"), session:session_1).save()
        new Result(startTime:50, endTime:105, task:Task.findByDescription("E"), session:session_1).save()
        new Result(startTime:50, endTime:106, task:Task.findByDescription("F"), session:session_1).save()
        new Result(startTime:50, endTime:107, task:Task.findByDescription("G"), session:session_1).save()
        new Result(startTime:50, endTime:108, task:Task.findByDescription("H"), session:session_1).save()
        new Result(startTime:50, endTime:109, task:Task.findByDescription("I"), session:session_1).save()
        new Result(startTime:50, endTime:110, task:Task.findByDescription("J"), session:session_1).save()
        new Result(startTime:50, endTime:111, task:Task.findByDescription("K"), session:session_1).save()
        new Result(startTime:50, endTime:112, task:Task.findByDescription("L"), session:session_1).save()
        new Result(startTime:50, endTime:113, task:Task.findByDescription("M"), session:session_1).save()
        new Result(startTime:50, endTime:114, task:Task.findByDescription("N"), session:session_1).save()
        new Result(startTime:50, endTime:115, task:Task.findByDescription("O"), session:session_1).save()
        new Result(startTime:50, endTime:116, task:Task.findByDescription("P"), session:session_1).save()
        new Result(startTime:50, endTime:117, task:Task.findByDescription("Q"), session:session_1).save()
        new Result(startTime:50, endTime:118, task:Task.findByDescription("R"), session:session_1).save()
        new Result(startTime:50, endTime:119, task:Task.findByDescription("S"), session:session_1).save()
        new Result(startTime:50, endTime:120, task:Task.findByDescription("T"), session:session_1).save()
        new Result(startTime:50, endTime:121, task:Task.findByDescription("U"), session:session_1).save()
        new Result(startTime:50, endTime:122, task:Task.findByDescription("V"), session:session_1).save()
        new Result(startTime:50, endTime:123, task:Task.findByDescription("W"), session:session_1).save()
        new Result(startTime:50, endTime:124, task:Task.findByDescription("X"), session:session_1).save()
        new Result(startTime:50, endTime:125, task:Task.findByDescription("Y"), session:session_1).save()
        new Result(startTime:50, endTime:126, task:Task.findByDescription("Z"), session:session_1).save()
        new Result(startTime:50, endTime:127, task:Task.findByDescription("AA"), session:session_1).save()

//        new Result(startTime:50, endTime:201, task:Task.findByDescription("A"), session:session_2).save()
//        new Result(startTime:50, endTime:202, task:Task.findByDescription("B"), session:session_2).save()
//        new Result(startTime:50, endTime:203, task:Task.findByDescription("C"), session:session_2).save()
//        new Result(startTime:50, endTime:204, task:Task.findByDescription("D"), session:session_2).save()
//        new Result(startTime:50, endTime:205, task:Task.findByDescription("E"), session:session_2).save()
//        new Result(startTime:50, endTime:206, task:Task.findByDescription("F"), session:session_2).save()
//        new Result(startTime:50, endTime:207, task:Task.findByDescription("G"), session:session_2).save()
//        new Result(startTime:50, endTime:208, task:Task.findByDescription("H"), session:session_2).save()
//        new Result(startTime:50, endTime:209, task:Task.findByDescription("I"), session:session_2).save()
//        new Result(startTime:50, endTime:210, task:Task.findByDescription("J"), session:session_2).save()
//        new Result(startTime:50, endTime:211, task:Task.findByDescription("K"), session:session_2).save()
//        new Result(startTime:50, endTime:212, task:Task.findByDescription("L"), session:session_2).save()
//        new Result(startTime:50, endTime:213, task:Task.findByDescription("M"), session:session_2).save()
//        new Result(startTime:50, endTime:214, task:Task.findByDescription("N"), session:session_2).save()
//        new Result(startTime:50, endTime:215, task:Task.findByDescription("O"), session:session_2).save()
//        new Result(startTime:50, endTime:216, task:Task.findByDescription("P"), session:session_2).save()
//        new Result(startTime:50, endTime:217, task:Task.findByDescription("Q"), session:session_2).save()
//        new Result(startTime:50, endTime:218, task:Task.findByDescription("R"), session:session_2).save()
//        new Result(startTime:50, endTime:219, task:Task.findByDescription("S"), session:session_2).save()
//        new Result(startTime:50, endTime:220, task:Task.findByDescription("T"), session:session_2).save()
//        new Result(startTime:50, endTime:221, task:Task.findByDescription("U"), session:session_2).save()
//        new Result(startTime:50, endTime:222, task:Task.findByDescription("V"), session:session_2).save()
//        new Result(startTime:50, endTime:223, task:Task.findByDescription("W"), session:session_2).save()
//        new Result(startTime:50, endTime:224, task:Task.findByDescription("X"), session:session_2).save()
//        new Result(startTime:50, endTime:225, task:Task.findByDescription("Y"), session:session_2).save()
//        new Result(startTime:50, endTime:226, task:Task.findByDescription("Z"), session:session_2).save()
//        new Result(startTime:50, endTime:227, task:Task.findByDescription("AA"), session:session_2).save()

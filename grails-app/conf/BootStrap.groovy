...
//        new Task(session:session_1, sequence:27, layer1:l_2, layer2:l_24, layer3:l_245, role:user, user:michael, system:s_email, media:m_mail, view:explicit, description:"AA").save()
        ...
        // results
        new Result(duration:101, task:Task.findByDescription("A"), session:session_1).save()
        new Result(duration:102, task:Task.findByDescription("B"), session:session_1).save()
        new Result(duration:103, task:Task.findByDescription("C"), session:session_1).save()
        new Result(duration:104, task:Task.findByDescription("D"), session:session_1).save()
        new Result(duration:105, task:Task.findByDescription("E"), session:session_1).save()
        new Result(duration:106, task:Task.findByDescription("F"), session:session_1).save()
        new Result(duration:107, task:Task.findByDescription("G"), session:session_1).save()
        new Result(duration:108, task:Task.findByDescription("H"), session:session_1).save()
        new Result(duration:109, task:Task.findByDescription("I"), session:session_1).save()
        new Result(duration:110, task:Task.findByDescription("J"), session:session_1).save()
        new Result(duration:111, task:Task.findByDescription("K"), session:session_1).save()
        new Result(duration:112, task:Task.findByDescription("L"), session:session_1).save()
        new Result(duration:113, task:Task.findByDescription("M"), session:session_1).save()
        new Result(duration:114, task:Task.findByDescription("N"), session:session_1).save()
        new Result(duration:115, task:Task.findByDescription("O"), session:session_1).save()
        new Result(duration:116, task:Task.findByDescription("P"), session:session_1).save()
        new Result(duration:117, task:Task.findByDescription("Q"), session:session_1).save()
        new Result(duration:118, task:Task.findByDescription("R"), session:session_1).save()
        new Result(duration:119, task:Task.findByDescription("S"), session:session_1).save()
        new Result(duration:120, task:Task.findByDescription("T"), session:session_1).save()
        new Result(duration:121, task:Task.findByDescription("U"), session:session_1).save()
        new Result(duration:122, task:Task.findByDescription("V"), session:session_1).save()
        new Result(duration:123, task:Task.findByDescription("W"), session:session_1).save()
        new Result(duration:124, task:Task.findByDescription("X"), session:session_1).save()
        new Result(duration:125, task:Task.findByDescription("Y"), session:session_1).save()
        new Result(duration:126, task:Task.findByDescription("Z"), session:session_1).save()
        new Result(duration:127, task:Task.findByDescription("AA"), session:session_1).save()

        new Result(duration:201, task:Task.findByDescription("A"), session:session_2).save()
        new Result(duration:202, task:Task.findByDescription("B"), session:session_2).save()
        new Result(duration:203, task:Task.findByDescription("C"), session:session_2).save()
        new Result(duration:204, task:Task.findByDescription("D"), session:session_2).save()
        new Result(duration:205, task:Task.findByDescription("E"), session:session_2).save()
        new Result(duration:206, task:Task.findByDescription("F"), session:session_2).save()
        new Result(duration:207, task:Task.findByDescription("G"), session:session_2).save()
        new Result(duration:208, task:Task.findByDescription("H"), session:session_2).save()
        new Result(duration:209, task:Task.findByDescription("I"), session:session_2).save()
        new Result(duration:210, task:Task.findByDescription("J"), session:session_2).save()
        new Result(duration:211, task:Task.findByDescription("K"), session:session_2).save()
        new Result(duration:212, task:Task.findByDescription("L"), session:session_2).save()
        new Result(duration:213, task:Task.findByDescription("M"), session:session_2).save()
        new Result(duration:214, task:Task.findByDescription("N"), session:session_2).save()
        new Result(duration:215, task:Task.findByDescription("O"), session:session_2).save()
        new Result(duration:216, task:Task.findByDescription("P"), session:session_2).save()
        new Result(duration:217, task:Task.findByDescription("Q"), session:session_2).save()
        new Result(duration:218, task:Task.findByDescription("R"), session:session_2).save()
        new Result(duration:219, task:Task.findByDescription("S"), session:session_2).save()
        new Result(duration:220, task:Task.findByDescription("T"), session:session_2).save()
        new Result(duration:221, task:Task.findByDescription("U"), session:session_2).save()
        new Result(duration:222, task:Task.findByDescription("V"), session:session_2).save()
        new Result(duration:223, task:Task.findByDescription("W"), session:session_2).save()
        new Result(duration:224, task:Task.findByDescription("X"), session:session_2).save()
        new Result(duration:225, task:Task.findByDescription("Y"), session:session_2).save()
        new Result(duration:226, task:Task.findByDescription("Z"), session:session_2).save()
        new Result(duration:227, task:Task.findByDescription("AA"), session:session_2).save()
    }
    def destroy = {
    }
